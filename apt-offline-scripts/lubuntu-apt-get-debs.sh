...
DST_DIR="/root/deb-lubuntu"
REMOTE_HOST="9.0.0.10"
REMOTE_DIR="/opt/custom-iso-ubuntu/deb-lubuntu"
REMOTE_USER="root"
...
apt-get -y install -d -o dir::cache=${DEB_DIR} \
        ...
        lubuntu-desktop lubuntu-default-settings \
        lubuntu-default-session lubuntu-extra-sessions \
        lubuntu-icon-theme lubuntu-lxpanel-icons \
        lubuntu-artwork lubuntu-artwork-14-04 \
...
rsync -avuzb ${DST_DIR}/ ${REMOTE_USER}@${REMOTE_HOST}:${REMOTE_DIR}
