...
ISO_NAME="ps-icehouse-trusty-amd64-${BUILD}.iso"
PS_LABEL="PS ICEHOUSE TRUSTY"
...
GRUB_CFG_ICE="${NEW_DIR}/boot/grub/grub.cfg.ice"

TXT_CFG="${NEW_DIR}/isolinux/txt.cfg"
TXT_CFG_ICE="${NEW_DIR}/isolinux/txt.cfg.ice"
